...
import {Create, Edit, List, Show, Datagrid, SelectField, ReferenceField, TextField, TextInput, DateInput, DateField, NumberField, NumberInput, EditButton, DeleteButton, TabbedShowLayout, Tab, TabbedForm, FormTab, SelectInput, ReferenceInput, FileField, FileInput, FormDataConsumer} from 'react-admin'
            ...
            <FormTab label="Laporan" path="report">
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question1?.total === 0 || formData?.report?.question1?.total  ) ?
                    <FileUpload source="report.question1.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question2?.total === 0 || formData?.report?.question2?.total ) ?
                    <FileUpload source="report.question2.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question3?.total === 0 || formData?.report?.question3?.total ) ?
                    <FileUpload source="report.question3.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question4?.total === 0 || formData?.report?.question4?.total ) ?
                    <FileUpload source="report.question4.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question5?.total === 0 || formData?.report?.question5?.total ) ?
                    <FileUpload source="report.question5.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question6?.total === 0 || formData?.report?.question6?.total ) ?
                    <FileUpload source="report.question6.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <FormDataConsumer >
                 {({ formData, ...rest }) => (formData?.report?.question7?.total === 0 || formData?.report?.question7?.total  ) ?
                    <FileUpload source="report.question7.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
                ...
                <NumberInput source="report.question8.total" label="Jumlah"/>
                 ...
                 {({ formData, ...rest }) => (formData?.report?.question8?.total === 0 || formData?.report?.question8?.total  ) ?
                    <FileUpload source="report.question8.file" {...rest}/>
                 : null
                 }
                </FormDataConsumer>
    ...
    <Show title={<PageTitle action="Show"/>} {...props}>
        <TabbedShowLayout>
            ...
            <Tab label="Laporan" path="report">
                ...
                <FileField source="report.question1.file.src" title="report.question1.file.title" />
